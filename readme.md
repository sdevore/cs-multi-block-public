...
1. Upload the plugin files to the `/wp-content/plugins/cs-multi-block-public` directory, or install the plugin through the WordPress plugins screen directly.
